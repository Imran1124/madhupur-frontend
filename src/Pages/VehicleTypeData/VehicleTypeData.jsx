...
const VehicleTypeData = () => {
  ...
  useSetTitle("Vehicle Type Master");
  const data = [
...

    {
      ...
      Cell: ({ cell }) => (
        <div className="flex">
          <button
            onClick={() =>
              navigate(`/vehicle-type-form/${cell.row.original?.id}`)
            }
  ...
  const fetchMasterList = (values = null) => {
    ...
    AxiosInterceptors.post(url, requestBody, ApiHeader())
      .then(function (response) {
        console.log("view vehicle type master..", response?.data?.data);
    ...
    <>
      <div className={`main-div`}>
        <div className="main-inner-div">
          ...
          <div className="main-sub-div">
            ...
            <div className="main-sub-inner-div">
              <div className="text-div">
                <div className="big-text">Vehicle Type Master List</div>
          ...
          <Tabs listRoute={"/vehicle-type"} formRoute={"/vehicle-type-form"} />

          <div className="mt-6">
            <span className="lists">Vehicle Type List</span>
          </div>
