...
export default function Communication(props) {
  ...
  const fun = (data) => {
    ...
    formData.append(
      "pDistrict",
      address?.p_district_id
    );
    formData.append(
      "cDistrict",
      address?.c_district_id
    );
    formData.append(
      "pState",
      address?.p_state_id
    ...
    formData.append(
      "pCountry",
      address?.p_country_id
    );
    formData.append(
      "cCountry",
      address?.c_country_id
    );
    formData.append(
      "pPincode",
      address?.p_pincode
    ...
    formData.append(
      "fathersName",
      address?.fathers_name
    );
    formData.append(
      "mothersName",
      address?.mothers_name
    );
    formData.append(
      "fathersQualification",
      address?.fathers_qualification
    );
    formData.append(
      "mothersQualification",
      address?.mothers_qualification
    );
    formData.append(
      "fathersOccupation",
      address?.fathers_occupation
    );
    formData.append(
      "mothersOccupation",
      address?.mothers_occupation
    );
    Swal.fire({
      icon: 'warning',
      title: 'Are you sure?',
  ...
  const saveMasterForm = (formData) => {
    ...
    url = api_editEmployeeAddressData;
