...
export default function FifthForm(props) {
  ...
  const { api_getcategorybynameData, api_getActiveBankData,api_editEmployeeBankData } = ApiList();
  ...
  const initialValues = {
    ...
    account_type: props?.editValue?.account_type,
    ifsc_code: props?.editValue?.ifsc_code,
    branch_name: props?.editValue?.branch_name,
    nominee_name: props?.editValue?.nominee_name,
    nominee_relation: props?.editValue?.nominee_relation_name,
    pan_no: props?.editValue?.pan_no,
    epf_no: props?.editValue?.epf_no,
    uan_no: props?.editValue?.uan_no,
    esi_no: props?.editValue?.esi_no,
    nps_no: props?.editValue?.nps_no
  };
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      const formdata={
        ...
        nomineeRelation:values?.nominee_relation,
        panNo:values?.pan_no,
        epfNo:values?.epf_no,
        uanNo:values?.uan_no,
        esiNo:values?.esi_no,
              ...
              <div className="w-full mx-[10px]  px-[10px]">
                <div>
                  ...
                  >
                    ...
                    {bank_name?.map((data) => (
                      <option
                        selected={data?.id === formik.values.bank_id}
                        value={data?.id}
                      >
                        {data?.bank_name}
                      </option>
                ...
                <div>
                  ...
                  >
                    ...
                    {categoryByNameData?.nominee_relation?.map((data) => (
                      <option
                        selected={
                          data?.subCatName === formik.values.nominee_relation
                        }
