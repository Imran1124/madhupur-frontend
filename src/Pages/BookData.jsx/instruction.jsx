        ...
        <div className=" bg-white lg:w-[900px]  rounded-lg shadow ">
          ...
          <div className="p-6 space-y-6">
            ...
            <h1 className="text-base leading-relaxed text-gray-500  ">
              <h1 className="font-bold">  Fill Data Through Form </h1>
            ...
            <h1 className='text-sm leading-relaxed text-gray-500 ml-[5rem]'>OR</h1>
            <h1 className="text-base leading-relaxed text-gray-500  ">
              <h1 className="font-bold">   Upload Data Through CSV File</h1>
          ...
          <div className="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b  justify-between">
            <div className="flex items-center justify-center text-green-600 ">
              ...
              {'  '}
              <a href="/book-data-csv.csv" target="_blank" rel="noreferrer">
