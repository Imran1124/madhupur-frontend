...
console.log(ownerRecord)
  ...
  const handlerow = (index, eachValue) => {
    formik.setFieldValue('exam_passed', eachValue.exam_passed_name);
    formik.setFieldValue('board', eachValue.board_uni_inst);
    formik.setFieldValue('passing_year', eachValue.passing_year);
    formik.setFieldValue('div_grade', eachValue.div_grade_name);
    ...
    formik.setFieldValue('upload_edu_doc', eachValue.upload_edu_doc ? eachValue.upload_edu_doc : formik.values.upload_edu_doc );
  };
                ...
                <div>
                  ...
                  >
                    ...
                    {categoryByNameData?.exam_passed?.map((data) => (
                      <option
                        selected={
                          data?.subCatName === formik.values.exam_passed
                        }
