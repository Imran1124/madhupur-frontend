...
function Submenu() {
  ...
  const { api_getSubmenuData, api_deleteSubmenuData, api_searchSubmenuData } =
    ApiList();
  ...
  const COLUMNS = [
...

    {
      ...
      Cell: ({ cell }) => (
        <div className="flex">
          <button
            onClick={() => navigate(`/sub-menu-form/${cell.row.original?.id}`)}
  ...
  const deleteItem = () => {
    ...
    AxiosInterceptors.post(api_deleteSubmenuData, requestBody, ApiHeader())
  ...
  const fetchMasterList = (values = null) => {
    ...
    if (values === null) {
      requestBody = {};
      url = api_getSubmenuData;
    } else {
      requestBody = {
        search: values?.search,
      };
      url = api_searchSubmenuData;
    }
    setisLoading(true);
    ...
    <>
      <div className={`main-div`}>
        <div className="main-inner-div">
          ...
          <div className="main-sub-div">
            <div className="main-sub-inner-div">
              <div className="text-div">
                <div className="big-text">Sub Menu Master List</div>
          ...
          <div className="mt-6">
            <span className="lists"> Sub Menu List</span>
          </div>
