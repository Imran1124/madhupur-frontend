...
function Menu() {
  ...
  const { api_getMenuData, api_deleteMenuData, api_searchMenuDataById } =
    ApiList();
  const navigate = useNavigate();

  useSetTitle("Menu Master");
  ...
  const COLUMNS = [
    ...
    },
    {
      ...
      Cell: ({ cell }) => (
        <span>
          <Icon icon={cell.row.original?.icon_name} className="w-6 h-6" />
        </span>
      ),
    },
    {
...

    {
      ...
      Cell: ({ cell }) => (
        <div className="flex">
          <button
            onClick={() => navigate(`/menu-form/${cell.row.original?.id}`)}
  ...
  const deleteItem = () => {
    ...
    AxiosInterceptors.post(api_deleteMenuData, requestBody, ApiHeader())
    ...
    <>
      <div className={`main-div`}>
        <div className="main-inner-div">
          ...
          <div className="main-sub-div">
            <div className="main-sub-inner-div">
              <div className="text-div">
                <div className="big-text">Menu Master List</div>
          ...
          <div className="mt-6">
            <span className="lists">Menu List</span>
          </div>
