...
const FeeHeadTypeDemo = () => {
  ...
  const {
    api_fetcHeadTypeList,
    api_searchHeadTypeList,
    api_postHeadType,
    api_editHeadType,
    api_getHeadTypeById,
    api_deleteHeadTypeById
  } = ApiList();
      ...
      .then(function (response) {
        if (response?.data?.status === true) {
          if (response?.data?.data?.total === 0) {
            ...
            console.log('Fee Head Type data', response?.data?.data?.data);
            setreadymadeListData(response?.data?.data?.data);
            setlastPage(response?.data?.data?.last_page);
            setlastData(response?.data?.data?.total);
          }
  ...
  const saveMasterForm = (values) => {
    ...
    } else if (values?.feeHeadType !== '' && currentId == null) {
    ...
    let value = e.target.value;
    {
      name == 'feeHeadType' &&
        formik.setFieldValue(
          'feeHeadType',
          allowCharacterInput(value, formik.values.feeHeadType, 50)
        );
    }
  };
                    ...
                    >
                      <div className="grid grid-cols-12 mt-6">
                        ...
                        <div className="col-span-12 lg:col-span-9">
                          <select
                            {...formik.getFieldProps('academicYr')}
                            disabled
                            type="text"
                      ...
                      <div className="grid grid-cols-12 mt-6">
                        ...
                        <div className="col-span-12 lg:col-span-9">
                          ...
                          <br />
                          <span className="text-red-600  text-xs">
                            {formik.touched.feeHeadType &&
                            formik.errors.feeHeadType
                              ? formik.errors.feeHeadType
                              : null}
                          </span>
                        </div>
...
export default FeeHeadTypeDemo;
