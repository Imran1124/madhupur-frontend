            ...
            {/* <div className="flex items-center justify-center mt-2 text-[22px]">
              <div className="flex items-center justify-center mt-2 text-[22px]">
                <input
                  ...
                  value="parent"
                  onChange={(e) => {
                    setParentDetail(e.target.value);
                  }}
                />
                <span className="ml-2 text-lg">Parent</span>
              </div>
              <input
                type="radio"
                className="ml-2"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 text-start mt-3">
          ...
          <div>
            <SelectField
              ...
              label="Qualification"
            >
              {getPublicMiscellaneous?.fathers_qualification?.map((data) => (
                <option
                  value={data?.id}
                  selected={data?.id == formik?.values.fathers_qualification_id}
                >
                  {data?.subCatName}
                </option>
              ))}
          ...
          <div>
            ...
            >
              {getPublicMiscellaneous?.fathers_occupation?.map((data) => (
                <option
                  value={data?.id}
                  selected={data?.id == formik?.values.fathers_occupation_id}
                >
                  {data?.subCatName}
                </option>
              ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 text-start mt-3">
          ...
          <div>
            <SelectField
              ...
              label="Qualification"
            >
              {getPublicMiscellaneous?.mothers_qualification?.map((data) => (
                <option
                  value={data?.id}
                  selected={data?.id == formik?.values.mothers_qualification_id}
                >
                  {data?.subCatName}
                </option>
              ))}
          ...
          <div>
            ...
            >
              {getPublicMiscellaneous?.mothers_occupation?.map((data) => (
                <option
                  value={data?.id}
                  selected={data?.id == formik?.values.mothers_occupation_id}
                >
                  {data?.subCatName}
                </option>
              ))}
          ...
          <div>
            ...
            >
              {getPublicMiscellaneous?.fathers_occupation?.map((data) => (
                <option
                  value={data?.id}
                  selected={data?.id == formik?.values.guardian_occupation_id}
                >
                  {data?.subCatName}
                </option>
              ))}
