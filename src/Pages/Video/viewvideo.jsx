...
fetchMasterList()
  ...
  const fetchMasterList = (values) => {
    ...
    if (values === undefined) {
      ...
      url = api_retrieve_video;
    } else {
      requestBody = {
        search: values
      };
      url = api_search_video;
    }
    setisLoading(true);
  ...
  return (
    <div>
        <div classNameName='p-6 h-[76vh] '>
            <h1 className=' text-[4vh] text-[#4338ca] font-bold '>View Video Gallery</h1>
        ...
        <div className="block w-[40vh] h-[40vh] m-[10px] rounded-[10px] shadow-lg">
          <div className="w-[40vh] h-[25vh] rounded-t-[10px]">
            <img src={Book} alt="pic1" className="h-[100%] w-[100%] rounded-t-[10px]" />
          </div>
          <div classNameName='w-full flex items-center justify-center px-5 '>
            <div className='flex mt-3 '> <div className='w-full ml-[5vh]'><h1 className="text-[3vh] font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-cyan-400 to-black ">Annual Fest</h1></div></div>
            ...
            <button className='mt-2 text-white bg-gradient-to-r from-[yellow] to-[#0c0a09] font-bold px-12 py-2 rounded-[10px]'>View Video Collection</button>
          </div>
        </div>
        <div className="block w-[40vh] h-[40vh] m-[10px] rounded-[10px] shadow-lg">
          <div className="w-[40vh] h-[25vh] rounded-t-[10px]">
          ...
          <div classNameName='w-full flex items-center justify-center px-5 '>
            <div className='flex mt-3 '> <div className='w-full ml-[5vh]'><h1 className="text-[3vh] font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-cyan-400 to-black ">Republic day</h1></div></div>
            {/* <p className="cardparagraph">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi
              suscipit aspernatur fuga enim esse, itaque, iusto in dolor eius
              dignissimos excepturi necessitatibus debitis soluta ratione hic,
        ...
        <div className="block w-[40vh] h-[40vh] m-[10px] rounded-[10px] shadow-lg">
          ...
          <div classNameName='w-full flex items-center justify-center px-5 '>
            <div className='flex mt-3 '> <div className='w-full ml-[5vh]'><h1 className="text-[3vh] font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-cyan-400 to-black ">Independance Day</h1></div></div>
            {/* <p className="cardparagraph">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi
              suscipit aspernatur fuga enim esse, itaque, iusto in dolor eius
              dignissimos excepturi necessitatibus debitis soluta ratione hic,
        ...
        <div className="block w-[40vh] h-[40vh] m-[10px] rounded-[10px] shadow-lg">
          ...
          <div classNameName='w-full flex items-center justify-center px-5 '>
            <div className='flex mt-3 '> <div className='w-full ml-[5vh]'><h1 className="text-[3vh] font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-cyan-400 to-black ">Concert</h1></div></div>
            {/* <p className="cardparagraph">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi
              suscipit aspernatur fuga enim esse, itaque, iusto in dolor eius
              dignissimos excepturi necessitatibus debitis soluta ratione hic,
