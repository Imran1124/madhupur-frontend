...
export default function ParentDetails(props) {
  ...
  const initialValues = {
    ...
    fathers_mobile: props?.editValue?.fathers_mob_no || '',
    mothers_mobile: props?.editValue?.mothers_mob_no || '',
    fathers_email: props?.editValue?.email || '',
    mothers_email: props?.editValue?.mothers_email || '',
    fathers_qualification_id: props?.editValue?.fathers_qualification_id || '',
    fathers_qualification_name:
      props?.editValue?.fathers_qualification_name || '',
    mothers_qualification_id: props?.editValue?.mothers_qualification_id || '',
    mothers_qualification_name:
      props?.editValue?.mothers_qualification_name || '',
    fathers_occupation_id: props?.editValue?.fathers_occupation_id || '',
    fathers_occupation_name: props?.editValue?.fathers_occupation_name || '',
    mothers_occupation_id: props?.editValue?.mothers_occupation_id || '',
    mothers_occupation_name: props?.editValue?.mothers_occupation_name || '',
    fathers_annual_income: props?.editValue?.fathers_annual_income || '',
    mothers_annual_income: props?.editValue?.mothers_annual_income || '',
    fathers_aadhar_no: props?.editValue?.fathers_aadhar || '',
    mothers_aadhar_no: props?.editValue?.mothers_aadhar || '',
    fathers_image: props?.editValue?.fathers_image || '',
    mothers_image: props?.editValue?.mothers_image || '',
    guardian_name: props?.editValue?.guardian_name || '',
    guardian_mobile: props?.editValue?.guardian_mob_no || '',
    guardian_email: props?.editValue?.guardian_email || '',
    guardian_occupation_id: props?.editValue?.guardian_occupation_id || '',
    guardian_occupation_name: props?.editValue?.guardian_occupation_name || '',
    guardian_qualification_id:
      props?.editValue?.guardian_qualification_id || '',
    guardian_qualification_name:
      props?.editValue?.guardian_qualification_name || '',
    guardian_aadhar_no: props?.editValue?.guardian_aadhar || '',
    guardian_annual_income: props?.editValue?.guardian_annual_income || '',
    relation: props?.editValue?.guardian_relation_id || ''
  };
