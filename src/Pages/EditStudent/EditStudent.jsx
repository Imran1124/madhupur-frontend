...
export default function EditStudent() {
  ...
  const getStudentById = () => {
    setisLoading(true);
    AxiosInterceptors.post(api_masters_student_crud_show, { id }, ApiHeader())
  ...
  return (
    <>
      <div
        className="w-full bg-white h-[86vh] flex relative max-[1200px]:overflow-hidden"
        // style={{ zIndex: 100 }}
      >
                ...
                {sixthdropdown ? (
                  <>
                    <div className="block  text-left ml-36 pl-10 text-black">
                      <StepsValue
                        labels="Route :"
                        value={allFormData?.transport?.route || ''}
                      />
                      <StepsValue
                        labels="Pick poin :"
                        value={allFormData?.transport?.pick_point || ''}
                      />
                      <StepsValue
                        labels="Bus no :"
