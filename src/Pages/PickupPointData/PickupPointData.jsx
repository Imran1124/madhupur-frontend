...
function PickupPointData() {
  ...
  useSetTitle("Pickup Point Master");
...

    {
      ...
      Cell: ({ cell }) => (
        <div className="flex">
          <button
            onClick={() =>
              navigate(`/pickup-point-form/${cell.row.original?.id}`)
            }
    ...
    <>
      <div className={`main-div`}>
        <div className="main-inner-div">
          ...
          <div className="main-sub-div">
            <div className="main-sub-inner-div">
              <div className="text-div">
                <div className="big-text">Pickup Point Master List</div>
          ...
          <Tabs listRoute={"/pickup-point"} formRoute={"/pickup-point-form"} />
...
export default PickupPointData;
