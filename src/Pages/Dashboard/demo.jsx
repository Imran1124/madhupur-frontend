...
function Demo() {
  ...
  const {
    ...
    api_getEmployeeDataActive,
    api_active_all_student,
    api_getvehicleData_active
  } = ApiList();
  ...
  const getemployeeUser = () => {
    setisLoading(true);
    AxiosInterceptors.post(api_getEmployeeDataActive, {}, ApiHeader())
  ...
  const getStudent = () => {
    setisLoading(true);
    AxiosInterceptors.post(api_active_all_student, {}, ApiHeader())
      .then(function (response) {
        console.log('view Employee Data..', response?.data?.data);
        if (response?.data?.status === true) {
  ...
  const fetchVehicleMaster = () => {
    setisLoading(true);
    AxiosInterceptors.post(api_getvehicleData_active, {}, ApiHeader())
      .then(function (response) {
  ...
  return (
    <>
      ...
      <div className={`w-full col-span-10 2xl:py-3 2xl:px-4 px-4 py-2 bg-white`}>
