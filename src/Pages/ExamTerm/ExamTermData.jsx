  ...
  const COLUMNS = [
...

    {
      ...
      Cell: ({ cell }) => (
        <div className="flex">
          <button
            onClick={() => navigate(`/exam-term-form/${cell.row.original?.id}`)}
    ...
    <>
      <div className={`main-div`}>
        <div className="main-inner-div">
          ...
          <div className="main-sub-div">
            <div className="main-sub-inner-div">
              <div className="text-div">
                <div className="big-text">Exam term List Masters</div>
          ...
          <div className="mt-6">
            <span className="lists">Exam term List </span>
          </div>
