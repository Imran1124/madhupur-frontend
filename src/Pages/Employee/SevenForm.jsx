...
export default function SevenForm(props) {
  ...
  const { api_getcategorybynameData, api_addEmployeeData } = ApiList();
  ...
  const func = (ownerRecord) => {
    ...
    formData.append('empNo', localStorage.getItem('employee number'));
    ...
    props?.allFormData?.education_detail.forEach((obj, index) => {
      ...
      formData.append(`educationDetails[${index}][board]`, obj?.board);
      formData.append(
        `educationDetails[${index}][passingYear]`,
        obj?.passing_year
      );
      formData.append(`educationDetails[${index}][divGrade]`, obj?.div_grade);
      formData.append(
  ...
  const adddata = () => {
    if (
      ...
      activateBottomErrorCard(true, 'Fill Feilds');
    }
  };
  ...
  const handlerow = (index, eachValue) => {
    ...
    formik.setFieldValue('f_member_relation', eachValue.f_member_relation);
    formik.setFieldValue('f_member_dob', eachValue.f_member_dob);
    formik.setFieldValue(
      'upload_f_member_image',
      eachValue.upload_f_member_image
    );
  };
      ...
      <div className="h-[82vh] w-[70%] bg-white overflow-auto  border border-slate-300 rounded-[15px]  max-[600px]:w-[95%]  max-[600px]:pb-[7vh] max-[320px]:pb-[10vh]">
        ...
        >
          <div className="mb-[1vh]">
            ...
            <div className="w-[95%] mt-[30px] flex mb-[20px] px-[10px] max-[917px]:block max-[917px]:w-[70%] max-[917px]:items-start max-[917px]:justify-start">
              <div className="w-1/2 mx-[10px]  px-[10px]">
                <div>
                ...
                <div>
                  ...
                  <div className="block justify-start">
                      <label
                        ...
                        className="form-control ml-[36px] mt-[-25px] rounded-[10px] h-10 block w-full border border-gray-200 px-3 py-2 2xl:text-base text-sm font-normal text-gray-700  bg-clip-padding  transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none placeholder-gray-300 shadow-md"
                      >
                        Choose File
                      </label>
                  <input
                    ...
                    onChange={(e) => {
                      formik.setFieldValue("upload_f_member_image", e.target.files[0]);
                    }}
                  />
                  {formik.values.upload_f_member_image
                  ...
                  {ownerRecord.length > 0 ? (
                    ...
                    ownerRecord.map((eachValue, index) => {
                      return (
                        <>
                          <tr
                            className="py-2 pl-4 w-full text-[16px] flex items-start justify-start text-[#696969] text-left verdana even:bg-gray-100"
                            key={index}
                          >
                            ...
                            <td className="w-full flex items-start justify-start">
                              {nullToNA(eachValue.upload_f_member_image.name)}
                            </td>
                            <td className="w-full flex items-start justify-start">
                              <button
                                type="button"
