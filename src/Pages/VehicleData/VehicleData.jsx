...
const VehicleData = () => {
  ...
  const { api_getvehicleData, api_deletevehicleData, api_searchvehicleData } =
    ApiList();
  ...
  const COLUMNS = [
...

    {
      ...
      Cell: ({ cell }) => (
        <div className="flex">
          <button
            onClick={() => navigate(`/vehicle-form/${cell.row.original?.id}`)}
    ...
    <>
      <div className={`main-div`}>
        <div className="main-inner-div">
          ...
          <div className="main-sub-div">
            <div className="main-sub-inner-div">
              <div className="text-div">
                <div className="big-text">Vehicle Master List</div>
          ...
          <div className="mt-6">
            <span className="lists">Vehicle List</span>
          </div>
