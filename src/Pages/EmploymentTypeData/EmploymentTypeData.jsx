...
const EmploymentTypeDemo = () => {
  ...
  const {
    api_getemploymenttypeDataById,
    api_getemploymenttypeData,
    api_searchemploymenttypeData,
    api_postemploymenttypeData,
    api_editemploymenttypeData,
    api_deleteemploymenttypeData,
  } = ApiList();
  ...
  const validationSchema = yup.object({
    empTypeName: yup
      ...
      .required("Employement type is required feild"),
  });
  ...
  const fetchMasterList = (values) => {
    ...
    if (values === undefined) {
      ...
      url = api_getemploymenttypeData;
    } else {
      requestBody = {
        search: values,
      };
      url = api_searchemploymenttypeData;
    }
    setisLoading(true);
  ...
  const sectionEditData = (data) => {
    ...
    formik.setFieldValue("empTypeName", data?.emp_type_name);
  };
  ...
  const saveMasterForm = (values) => {
    ...
    let requestBody;
    let requestBodyBase = {
      empTypeName: values.empTypeName,
    };
    if (currentId !== null) {
      url = api_editemploymenttypeData;
      requestBody = requestBodyBase;
      requestBody.id = currentId;
    } else if (values?.teachingTitleName !== "" && currentId == null) {
      url = api_postemploymenttypeData;
      requestBody = requestBodyBase;
    }
    ...
    let value = e.target.value;
    {
      name == "empTypeName" &&
        formik.setFieldValue(
          "empTypeName",
          allowCharacterInput(value, formik.values.empTypeName, 50)
        );
    }
  };
  ...
  const column = [
    { title: "Employment Type", feild: "emp_type_name" },
  ...
  const generatePdf = () => {
    const doc = new jsPDF();
    doc.text("Employment Type Details", 10, 10);
    doc.autoTable({
      theme: "grid",
                    ...
                    >
                      <div className="grid grid-cols-12 mt-6 w-full">
                        ...
                        <div className="col-span-12 lg:col-span-8 w-full">
                          <input
                            {...formik.getFieldProps("empTypeName")}
                          ...
                          <span className="text-red-600  text-xs">
                            {formik.touched.empTypeName &&
                            formik.errors.empTypeName
                              ? formik.errors.empTypeName
                              : null}
                          </span>
                        </div>
...
export default EmploymentTypeDemo;
