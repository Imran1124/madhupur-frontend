...
function MarksTabulationData() {
  ...
  const {
    api_getMarksTabulationData,
    api_searchMarksTabulationData,
    api_deleteMarksTabulationData
  } = ApiList();
  ...
  const fetchMasterList = (values = null) => {
    ...
    if (values === null) {
      ...
      url = api_getMarksTabulationData;
    } else {
      requestBody = {
        search: values?.search
      };
      url = api_searchMarksTabulationData;
    }
    setisLoading(true);
          ...
          <div className="main-sub-div">
            <div className="main-sub-inner-div">
              <div className="text-div">
                <div className="big-text">Marks Tabulation Report List</div>
...
export default MarksTabulationData;
