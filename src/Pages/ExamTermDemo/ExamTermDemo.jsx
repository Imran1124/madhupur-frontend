...
const ExamTermDemo = () => {
  ...
  const {
    ...
    api_getExamTermData,
    api_searchExamTermData,
    api_postExamTermData,
    api_editExamTermData,
    api_deleteExamTermData,
  } = ApiList();
  ...
  const saveMasterForm = (values) => {
    ...
    } else if (values?.termName !== "" && currentId == null) {
  ...
  const deleteItem = () => {
    ...
    AxiosInterceptors.post(api_deleteExamTermData, requestBody, ApiHeader())
      .then(function (response) {
        if (response?.data?.status === true) {
          fetchMasterList();
  ...
  const column = [
    { title: "Exam Term", feild: "term_name" },
                    ...
                    >
                      <div className="grid grid-cols-12 mt-6">
                        <div className=" col-span-12 lg:col-span-3">
                          <label
                            className=" flex items-start justify-start ml-2 text-teal-900 text-md  font-bold"
                            htmlFor=""
                          >
                            Exam Term
