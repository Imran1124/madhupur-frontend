...
export default function SevenForm(props) {
  const { api_getactiveClassData, api_getSectionData } = ApiList();
  ...
  const handleOnChange = (e) => {
    ...
    let value = e.target.value;
    {
      name == 'sibling_name' &&
        formik.setFieldValue(
          'sibling_name',
          allowCharacterInput(value, formik.values.sibling_name, 10)
        );
    }
    {
      name == 'roll_no' &&
        formik.setFieldValue(
          'roll_no',
          allowNumberInput(value, formik.values.roll_no, 10)
        );
    }
  };
        ...
        >
          <div className="mb-[1vh]">
            ...
            <div className="w-[90%] mt-[30px] flex mx-auto  mb-[20px]  ">
              <div className="mb-[1vh]  overflow-scroll  max-[768px]:w-[750px]">
          ...
          <div className="flex items-end justify-end pb-[150px] mr-[70px] max-[768px]:block  max-[768px]:mr-0">
