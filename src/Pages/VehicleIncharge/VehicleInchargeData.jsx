...
function VehicleInchargeData() {
  ...
  const {
    ...
    api_deleteVehicle_inchargeData,
    api_searchVehicle_inchargeData,
  } = ApiList();
  const navigate = useNavigate();

  useSetTitle("City Type Master");
    ...
    },
    {
      ...
      Cell: ({ cell }) => (
        <div className="flex">
          <button
            onClick={() =>
              navigate(`/vehicleincharge-form/${cell.row.original?.id}`)
            }
  ...
  const fetchMasterList = (values = null) => {
    ...
    if (values === null) {
      ...
      url = api_getVehicle_inchargeData;
    } else {
      requestBody = {
        search: values?.search,
      };
      url = api_searchVehicle_inchargeData;
    }
    setisLoading(true);
    ...
    <>
      <div className={`main-div`}>
        <div className="main-inner-div">
          ...
          <div className="main-sub-div">
            <div className="main-sub-inner-div">
              <div className="text-div">
                <div className="big-text">Vehicle Incharge Master List</div>
                <div className="small-text text-teal-500">
          ...
          <div className="mt-6">
            <span className="lists text-[#0F766E]">Vehicle Incharge List </span>
          </div>
...
export default VehicleInchargeData;
