...
function StateMasterForm() {
  ...
  const saveMasterForm = (values) => {
    ...
    AxiosInterceptors.post(url, requestBody, ApiHeader())
      .then(function (response) {
        console.log("view State master..", response?.data?.data);
  ...
  const fetchStateHeadTypeList = () => {
    AxiosInterceptors.post(api_getCountryData, {}, ApiHeader())
      .then(function (response) {
        if (response?.data?.status) {
      ...
      <div className={`main-div`}>
        <div className="main-inner-div">
          ...
          <div className="main-sub-div">
            <div className="main-sub-inner-div">
              <div className="text-div">
                <div className="big-text">State Master Form</div>
          ...
          {id !== undefined ? (
            ...
            <Tabs listRoute={"/state"} formRoute={"/state-form"} />
          )}
          <div className="details-div">
            <span className="detailes">Details of State</span>
          </div>
