...
function RouteData() {
  ...
  const { api_getRouteData, api_deleteRouteData, api_searchRouteData } =
    ApiList();
  const navigate = useNavigate();

  useSetTitle("Route Master");
  ...
  const COLUMNS = [
...

    {
      ...
      Cell: ({ cell }) => (
        <div className="flex">
          <button
            onClick={() => navigate(`/route-form/${cell.row.original?.id}`)}
    ...
    <>
      <div className={`main-div`}>
        <div className="main-inner-div">
          ...
          <div className="main-sub-div">
            <div className="main-sub-inner-div">
              <div className="text-div">
                <div className="big-text">Route Master List</div>
          ...
          <div className="mt-6">
            <span className="lists">Route List</span>
          </div>
