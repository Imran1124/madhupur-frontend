...
function RouteMasterForm() {
  ...
  const validationSchema = yup.object({
    routeName: yup
      ...
      .required("Category is required feild"),
  });
    ...
    AxiosInterceptors.post(api_getRouteDataById, requestBody, ApiHeader())
      .then(function (response) {
        if (response?.data?.status) {
          routeEditData(response?.data?.data);
        } else {
          activateBottomErrorCard(true, `${response?.data?.message}`);
        }
        setisLoading(false);
  ...
  const routeEditData = (data) => {
    formik.setFieldValue("id", data?.id);
    formik.setFieldValue("routeName", data?.route_name);
  };
  const routeTypeList = () => {
    AxiosInterceptors.post(api_getRouteData, {}, ApiHeader())
      .then(function (response) {
        if (response?.data?.status) {
      ...
      <div className={`main-div`}>
        <div className="main-inner-div">
          ...
          <div className="main-sub-div">
            <div className="main-sub-inner-div">
              <div className="text-div">
                <div className="big-text">Route Master Form</div>
          ...
          {id !== undefined ? (
            ...
            <Tabs listRoute={"/route"} formRoute={"/route-form"} />
          )}
          <div className="details-div">
            <span className="detailes">Details of Route </span>
          </div>
