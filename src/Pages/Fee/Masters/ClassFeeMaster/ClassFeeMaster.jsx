...
function ClassFeeMaster() {
  ...
  const {
    api_fetchClassFeeList,
    api_deleteClassFeeById,
    api_getClassFeeById,
    api_searchClassFeeList,
  } = ApiList();
  ...
  const COLUMNS = [
    ...
    },
    {
      ...
      Cell: ({ cell }) => (
        <span>{nullToNA(cell.row.original.fee_head_type)}</span>
      ),
    },
    {
      Header: "Fee Head",
    ...
    //   Header: "Fee Amount",
    //   accessor: "fee_amount",
    //   Cell: ({ cell }) => (<span>{nullToNA(cell.row.original.fee_amount)}</span>)
    // },

    // {
    //   Header: "Discount %",
    //   accessor: "discount",
    //   Cell: ({ cell }) => (<span> {nullToNA(cell.row.original.discount)}</span>)
    // },
    // {
    //   Header: "Net Fee",
    //   accessor: "net_fee",
    //   Cell: ({ cell }) => (<span>{nullToNA(cell.row.original.net_fee)}</span>)
    // },
    // {
    //   Header: "Jan Fee",
    //   accessor: "jan_fee",
    ...
    },
    {
      ...
      Cell: ({ cell }) => (
        <div className="flex">
          <button
            onClick={() =>
              navigate(`/classfee-master-form/${cell.row.original?.id}`)
            }
    ...
    <>
      <div className={`main-div`}>
        <div className="main-inner-div">
              ...
              <div className="global-filter-div">
                ...
                <div className="hiplus-div">
                  <button
                    ...
                    type="button"
                    className="hiplus-button bg-[#0F766E] hover:bg-[#0F766E]"
                  >
          ...
          <div className="mt-6">
            <span className="lists text-[#0F766E]">
              {" "}
              Class Fee Master List ({readymadeListData[0]?.academic_year})
            </span>
          </div>
