...
function ClassData() {
  ...
  const { api_getSectionData, api_deleteSectionData, api_searchSectionData } =
    ApiList();
  ...
  const deleteItem = () => {
    ...
    AxiosInterceptors.post(api_deleteSectionData, requestBody, ApiHeader())
  ...
  const fetchMasterList = (values = null) => {
    ...
    if (values === null) {
      requestBody = {};
      url = api_getSectionData;
    } else {
      requestBody = {
        search: values?.search,
      };
      url = api_searchSectionData;
    }
    setisLoading(true);
    ...
    <>
      <div className={`main-div`}>
        <div className="main-inner-div">
          ...
          <div className="main-sub-div">
            <div className="main-sub-inner-div">
              <div className="text-div">
                <div className="big-text">Section Master List</div>
          ...
          <div className="mt-6">
            <span className="lists">Section List</span>
          </div>
