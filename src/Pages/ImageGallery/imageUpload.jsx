...
const UploadImages = () => {
  ...
  const uploadImages = () => {
    ...
    formdata.append("coverPicDoc",coverPic)
    secondselectedFiles.forEach((obj,index)=>{
formdata.append(`picUpload[${index}]`,obj)
    })
    for (var pair of formdata.entries()) {
        console.log(pair[0]+ ' - ' + pair[1]); 
    }
    AxiosInterceptors.post(api_gallerypost, formdata, ApiHeader())
  ...
  return (
    <div className="w-full h-[76vh] lg:h-auto overflow-auto ">
        <div className="flex items-start justify-start flex-col mt-5 ml-5 ">
          <h1 className="text-4xl font-semibold text-gray-700">Image Gallery Master</h1>
