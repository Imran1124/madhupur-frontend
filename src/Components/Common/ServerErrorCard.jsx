...
// DESCRIPTION - This component is rendeindigo when there is some error in hitting the api to show text like server is busy..
      ...
      <div class="items-center justify-center p-10 bg-white shadow-xl">
        ...
        <div className=" p-10">
          <div>
            ...
            <p class="text-slate-600 mt-1 lg:text-lg text-center">{props?.desc}</p>
