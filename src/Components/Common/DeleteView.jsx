        ...
        <CommonModal>
            <div style={{ 'zIndex': 9999999 }} class="relative bg-white rounded-lg shadow-xl border-2 border-gray-50">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 darks:text-gray-400">Are you sure to {props?.deactivate==="active" ? "activate" : "deactivate"} ?</h3>
                    <button type="button" className="cypress_button_logout text-white bg-indigo-600 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-red-300 darks:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2" onClick={props?.deleteItem}>
                        Yes
                    </button><button type="button" className="cypress_button_logout text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 darks:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2" onClick={() => props?.setdeleteStatus(false)}>
                       No
                    </button>
