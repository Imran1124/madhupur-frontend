        ...
        <>
            ...
            <div className=" py-2 overflow-x-auto bg-white">
                <div className="inline-block min-w-full rounded-lg overflow-hidden bg-white">
                    <table {...getTableBodyProps} className="min-w-full max-[940px]:w-[940px] max-[940px]:overflow-auto">
                        ...
                        <tbody {...getTableBodyProps()} className="text-sm border-b">
                            ...
                            {page?.map((row) => {
                                prepareRow(row)
                                return (
                                    <tr {...row.getRowProps()} className="bg-white hover:bg-blue-100 rounded-md">
                                        {row?.cells?.map((cell ,index) => {
                                            return <td {...cell.getCellProps()} className={`${index == 0 && `rounded-l-[12px] `} ${index == (row?.cells?.length - 1) && `rounded-r-[12px] `} px-2 py-3 text-md text-left text-gray-600`}>{cell.render('Cell')}</td>
                                        })}
                                    </tr>
                                )
                            })}
                    ...
                    <div className='mt-3 grid grid-cols-12'>
                        ...
                        <div className='col-span-4 text-center col-start-5 text-[#0F766E]'>   <span >
                            page {''}
                            <strong>
